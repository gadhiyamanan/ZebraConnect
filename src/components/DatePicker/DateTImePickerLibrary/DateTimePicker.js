      ...
      this.setState(
        {
          date: Moment(new Date()).set({
            hour: Number(time.hour) + (time.amOrPm === "AM" ? 0 : 12),
    ...
    return (
      ...
      >
        <View style={[Style.dateTouchBody, customStyles.dateTouchBody]}>
          ...
          {/* {(mode === 'time' && this.state.isPicker)?<DateTimePicker isVisible={mode === 'time' && this.state.isPicker} mode="time" display="spinner" value={this.state.date} onConfirm={this.onTimePicked}/>:null}
          {(mode === 'date' && this.state.isPicker)?<DateTimePicker isVisible={mode === 'date' && this.state.isPicker} mode="date" minimumDate={minDate && this.getDate(minDate)} maximumDate={maxDate && this.getDate(maxDate)} value={this.state.date} onConfirm={this.onDatePicked}/>:null} */}
          <TimePicker
          ...
          />
          <DateTimePicker
            isVisible={mode === "date" && this.state.isPicker}
            mode="date"
            minimumDate={minDate && this.getDate(minDate)}
            maximumDate={maxDate && this.getDate(maxDate)}
